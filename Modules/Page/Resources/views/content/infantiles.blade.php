          ...
          <div class="row">
            <div class="col-sm-12 overflow-hidden">
              <div class="iq-main-header d-flex align-items-center justify-content-between">
                <h4 class="main-title">Infantiles</h4>
                    ...
                    <div class="block-images position-relative">
                      ...
                      <div class="block-description">
                        ...
                        <div class="movie-time d-flex align-items-center my-2">
                          ...
                          <span class="text-white">Enseñar a aprender y aprender a enseñar</span>
                        </div>
                        <div class="hover-buttons">
                          <span class="btn btn-hover iq-button">
                            <i class="fa fa-play mr-1"></i>
                    ...
                    <div class="block-images position-relative">
                      ...
                      <div class="block-description">
                        ...
                        <div class="movie-time d-flex align-items-center my-2">
                          ...
                          <span class="text-white">Cree en el “cine de descubrimiento”</span>
                        </div>
                        <div class="hover-buttons">
                          <span class="btn btn-hover iq-button">
                            <i class="fa fa-play mr-1"></i>
                    ...
                    <div class="block-images position-relative">
                      ...
                      <div class="block-description">
                        ...
                        <div class="movie-time d-flex align-items-center my-2">
                          ...
                          <span class="text-white">“El cine comprometido es una necesidad”</span>
                        </div>
                        <div class="hover-buttons">
                          <span class="btn btn-hover iq-button">
                            <i class="fa fa-play mr-1"></i>
                  ...
                  <li class="slide-item">
                    <div class="block-images position-relative">
                      ...
                      <div class="block-description">
                        ...
                        <div class="movie-time d-flex align-items-center my-2">
                          {{-- <div class="badge badge-secondary p-1 mr-2">12+</div> --}}
                          <span class="text-white">El reto del cine venezolano es verse en otros países</span>
                        </div>
                        <div class="hover-buttons">
                          <span class="btn btn-hover iq-button">
                            <i class="fa fa-play mr-1"></i>
